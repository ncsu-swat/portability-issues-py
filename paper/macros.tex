...
\newcommand{\PaperTitle}{An Empirical Analysis of Cross-OS Portability\\ Issues in Python Projects}
...
\newcommand{\RQTwoTwo}{\EQ{2.2}: What are the observable symptoms of portability issues?}
...
% \newcommand{\ourrepo}{\url{https://github.com/portability-py-project/msr-submission}}

\newcommand{\ourrepo}{\url{https://github.com/ncsu-swat/portability-issues-py}}
...
% ========================================
% RQ2: TAXONOMY STATISTICS
% ========================================
\newcommand{\NumRootCauseCategories}{7}               % Number of high-level root-cause categories
\newcommand{\NumRootCauseSubcategories}{24}           % Number of distinct sub-categories
\newcommand{\NumSymptomSignatures}{15}                % Number of unique symptom signatures (not context-dependent)
\newcommand{\NumContextSymptoms}{9}                   % Number of context-dependent symptoms
\newcommand{\NumFixPatterns}{4}                       % Number of general fix patterns
...
\newcommand{\TotalPRAccepted}{17}
\newcommand{\TotalPRRejected}{0}
\newcommand{\TotalPRInTestsCode}{17}
\newcommand{\TotalPRInProgramCode}{10}
\newcommand{\TotalPRInBothCode}{6}
\newcommand{\TotalPRAprovedPercent}{51.5\%}
\newcommand{\TotalPRInProgramPercent}{30.3\%}
\newcommand{\TotalPRInTestsPercent}{51.5\%}
\newcommand{\TotalPRInBothPercent}{18.2\%}
...
% Define colors for symptom types (used only in Table~\ref{tab:symptoms})
\definecolor{UniqueSymptomColor}{RGB}{200,230,255}     % light blue background
\definecolor{ContextSymptomColor}{RGB}{255,250,205}    % light yellow background
...
% Commands for symptom cell backgrounds
\newcommand{\UniqueSymptom}[1]{\cellcolor{UniqueSymptomColor}#1}
\newcommand{\ContextSymptom}[1]{\cellcolor{ContextSymptomColor}#1}
