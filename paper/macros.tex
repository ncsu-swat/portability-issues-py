...
\newcommand{\Abid}[1]{\textcolor{teal}{Abid:[#1]}}
...
\newcommand{\PaperTitle}{An Empirical Analysis of Portability Issues in Python Test Cases}
...
% RQ1: Target API counts and overlaps (Table~\ref{tab:num_target_apis})
\newcommand{\rqOneTorchTotalAPIs}{1,151\xspace}
\newcommand{\rqOneTorchIntersectACE}{284\xspace}
\newcommand{\rqOneTorchIntersectPathfinder}{529\xspace}
\newcommand{\rqOneTorchIntersectTTFuzz}{469\xspace}

\newcommand{\rqOneTFTotalAPIs}{662\xspace}
\newcommand{\rqOneTFIntersectACE}{519\xspace}
\newcommand{\rqOneTFIntersectPathfinder}{478\xspace}
\newcommand{\rqOneTFIntersectTTFuzz}{643\xspace}

\newcommand{\libfuzzer}{libFuzzer\xspace}
...
\newcommand{\RepoURL}{\url{https://anonymous.4open.science/r/deep-learning-apis-cgfuzzing}}
\newcommand{\Identifier}{\textsc{\IMM Identifier}\xspace}
\newcommand{\Classifier}{\textsc{\IMM Classifier}\xspace}
\newcommand{\Generator}{\textsc{Policy Generator}\xspace}
\newcommand{\Transformer}{\textsc{Code Transformer}\xspace}
\newcommand{\instructions}{instrumentation configurations\xspace}

% numbers
\newcommand{\numBugs}{42\xspace}
\newcommand{\numBugsTorch}{20\xspace}
\newcommand{\numBugsTF}{22\xspace}
\newcommand{\numBugsFix}{8\xspace}
