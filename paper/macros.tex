...
\newcommand{\PaperTitle}{An Empirical Analysis of Portability Issues in Python}
...
\newcommand{\RQTwo}{\EQ{2}: What are the characteristics, causes, manifestations, and fixes of portability problems in Python software?}
