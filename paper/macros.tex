...
\newcommand{\RQTwoTwo}{\EQ{2.2}: How do portability issues manifest and how can they be detected?}
\newcommand{\RQTwoThree}{\EQ{2.3}: What are effective fix patterns for addressing portability issues?}
...
% ========================================
% Test Re-execution Approach (RQ1 table a)
% ========================================
\newcommand{\NumProjects}{2,042}
\newcommand{\NumProjectsAnalyzed}{500}
\newcommand{\NumProjectsWithOSDiffInTests}{56}
\newcommand{\NumTestsExecuted}{440,728}
\newcommand{\NumTestRunsWithOSDiff}{9,508}
\newcommand{\PercentDiscrepantTests}{2.16\%}
\newcommand{\NumCodeUsedLLM}{90}
\newcommand{\NumCodeNonPortableByLLM}{30}
\newcommand{\NumCodePortableIssue}{30}
\newcommand{\NumCodePortableManual}{30}



% Calculated percentage: projects with portability issues from test re-execution
\usepackage{xfp}
\newcommand{\PercentProjectsWithPortabilityReExecution}{%
  \fpeval{round(56/500*100, 1)}\%}

% ========================================
% Issue Mining Approach (RQ1 - Table b)
% ========================================
\newcommand{\NumProjectsWithOSDiffInIssues}{95}
\newcommand{\NumIssuesMined}{2,617}
\newcommand{\NumIssuesAnalyzed}{240}
\newcommand{\NumIssuesRelated}{102}

% Total projects with portability issues (from both test re-execution and issue mining)
\newcommand{\TotalProjectsWithPortabilityIssues}{151}

% ========================================
% Pull Request Statistics (RQ4)
% ========================================
