...
\begin{table}[t!]
  \centering
  \caption{\label{tab:dataset}Prevalence of portability
    problems.\Mar{Complete and check if this is consistent with text.}}
  \vspace{-1ex}
...
The resulting taxonomy of root causes consists of \textbf{7}
high-level categories (e.g., FILE, PROC, LIB) with \textbf{24}
