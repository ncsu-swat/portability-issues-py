...
Next, we highlight two representative pull requests\Mar{Is there a
  reason for the two discussed PR to be of the same kind? If you think
there is are good representative, justify it.} that illustrate
