...
\noindent\begin{table*}[t]
    ...
    \midrule
    \textbf{LIB} &
    Platform-specific libraries (e.g., fcntl) & \UniqueSymptom{\texttt{ModuleNotFoundError: No module named `fcntl'} (Windows)} & \DefensivePattern{} — conditional import provide fallback \\
