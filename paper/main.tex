...
on certain platforms and accounts for 32.1\% of pattern applications.
...
followed by Defensive checks with 9 applications (32.1\%), together
...
Defensive checks (32.1\%), Normalization (21.4\%), and Portable APIs (10.7\%). 
