...
Next, we highlight three\Fix{two?} representative pull requests that illustrate
...
\Mar{I don't see a need for three example. Show two only. Choose the
  two most interesting ones.}

\begin{tcolorbox}[boxrule=0pt,sharp corners,boxsep=2pt,left=2pt,right=2pt,top=2.5pt,bottom=2pt]
  \textbf{RQ\textsubscript{4}:}~ \Mar{We need a summary here!!!}
\end{tcolorbox}
