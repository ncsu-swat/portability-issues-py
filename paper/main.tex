...
with both detection approaches, and obtained a 48\% pull-request
...
This study provides the first comprehensive characterization of
portability issues in Python code. We found that 16.8\% of projects
exhibit portability problems%(11.2\% via test re-execution and 23.8\%
via issue mining) , with File and Directories operations being most
prevalent. Our taxonomy shows 7 root-cause categories (with 24
