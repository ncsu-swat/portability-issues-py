...
``Encoding'' subcategory within the ``File and Directories''
...
\noindent\textbf{Setup.}~We sampled a total of 90\Mar{macro} code
snippets to evaluate performance of LLM: (i)~30~non-portable snippets
containing OS-specific constructs, (ii)~30~portable snippets that had
been fixed by developers (mined from issues), and (iii)~30~code we
...
classification of the 90\Mar{macro!} samples and
...
\subsubsection{LLMs for fixing.}\Mar{@Denini, can you follow a similar
approach to above and revise this text???}
