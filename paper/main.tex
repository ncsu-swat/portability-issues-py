...
This study provides the first comprehensive empirical characterization of portability issues in Python code. Through cross-OS test re-execution and issue mining, we found that 16.8\% of projects exhibit portability problems (11.2\% via test re-execution, 23.8\% via issue mining), with File and Directories operations being most prevalent. 
Our taxonomy identifies 7 root-cause categories with 24 sub-categories and 4 general fix patterns. LLMs achieve 40-79\% detection accuracy and 50-77\% repair success when guided by structured patterns. Our findings are validated through 33 pull requests with 48\% acceptance rate.
