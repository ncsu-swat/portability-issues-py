...
\begin{tcolorbox}[boxrule=0pt,sharp corners,boxsep=2pt,left=2pt,right=2pt,top=2.5pt,bottom=2pt]
  ...
  achieving a 48\% acceptance rate with no rejections. Issues related
  ...
  generally involve localized changes—either to test code (51.5\%) or
  application logic (30.3\%)—and suggest a positive response from
