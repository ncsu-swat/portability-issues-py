...
\textbf{Dataset.} We sampled \NumProjects{} Python repositories from
...
%; the analyses reported here reflect the first \NumProjectsAnalyzed{} analyzed.  
...
%     Number of projects mined & \NumProjects{} \\
     Number of projects selected & \NumProjectsAnalyzed{} \\
  ...
  \begin{subtable}[t]{\linewidth}
    ...
    \begin{tabular}{lr}
      \toprule
       Number of projects selected & \Fix{???} \\
