...
\begin{table*}[t]
    ...
    \multirow{3}{*}{File and Directories} & Path name convention & 27 & - & 7 & - & - \\
     & Line ending & ? & - & ? & - & - \\
     & Case sensitivity & 0 & - & ? & - & - \\     
...
%%     & \begin{tabular}[c]{@{}c@{}}9\end{tabular} & \textbf{41} \\
    ...
    \begin{tabular}[c]{@{}l@{}}
    Command execution mismatch (os.system / subprocess / popen) \\
    Signal handling (e.g., SIGKILL, SIGHUP) \\
    ...
    \begin{tabular}[c]{@{}l@{}}
    lib fcntl dont works in windows \\
    Missing a lib \\
    ...
    \begin{tabular}[c]{@{}l@{}}
    no display avaliable in github ci for linux \\
    GUI / window-manager differences \\
    Curses maybe not avaliable Win \\
    ...
    method does not exist: os.geteuid() \\
    method does not exist: os.getuid() \\
    Method does not exist: os.getpgid() \\
    module does not exist: readline \\
    module does not exist: resource
    \end{tabular}
    & \begin{tabular}[c]{@{}r@{}}
    1 \\
    0 \\
