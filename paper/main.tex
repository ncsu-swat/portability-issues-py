...
Al Awar \etal{} present PyKokkos, a Python framework that attains performance portability by translating Python kernels into optimized C++ Kokkos code~\cite{al2021performance}. Their approach enables near-native execution while keeping development in Python. Like other performance-portable systems, PyKokkos addresses architectural efficiency, whereas our work focuses on OS-level inconsistencies across operating systems.
