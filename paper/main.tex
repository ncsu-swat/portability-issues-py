...
In the second configuration (\textit{pattern-guided prompt}), each non-portable snippet was accompanied by a description of the specific portability issue (derived from our taxonomy in RQ2) and the corresponding \textit{General Fix Pattern} from Table~\ref{tab:symptoms}.  
