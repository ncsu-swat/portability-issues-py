...
\begin{table*}[t]
    \centering
    \caption{Diagnostic symptom signatures for selected portability subcategories.}
    \label{tab:symptoms}
    \scriptsize
    \setlength{\tabcolsep}{3pt}
    \renewcommand{\arraystretch}{1.15}
    ...
    \toprule
    \textbf{Root-cause category} & \textbf{Sub-categories} & \textbf{Symptom (verbatim error / message)} \\
    \midrule
    File and Directories &
    Line ending & \texttt{AssertionError: '\textbackslash r\textbackslash n' != '\textbackslash n'} \\
    & Case sensitivity & \texttt{FileNotFoundError: [Errno 2] No such file or directory: 'Readme.md'} \\
    \midrule
